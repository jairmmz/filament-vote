    ...
    <div class="container mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 sticky top-8">
                ...
                {{-- Share --}}
                <div class="bg-white dark:bg-[#1D293D] rounded-lg shadow-lg p-6 overflow-hidden flex gap-4 justify-center items-center">
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('polls.show', $poll->slug)) }}"
                       target="_blank"
                       rel="noopener noreferrer"
                            class="w-12 h-12 rounded-full bg-[#1877F2] hover:bg-[#0d65d9] text-white flex items-center justify-center transition-all hover:scale-110 shadow-lg">
                    ...
                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('polls.show', $poll->slug)) }}&text={{ urlencode('Mira los resultados de: ' . $poll->title) }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="w-12 h-12 rounded-full bg-[#000000] hover:bg-[#1a1a1a] text-white flex items-center justify-center transition-all hover:scale-110 shadow-lg">
                    ...
                    <a href="https://api.whatsapp.com/send?text={{ urlencode('Mira los resultados de: ' . $poll->title . ' ' . route('polls.show', $poll->slug)) }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#1fb355] text-white flex items-center justify-center transition-all hover:scale-110 shadow-lg">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.instagram.com/"
                       ...
                       class="w-12 h-12 rounded-full bg-gradient-to-tr from-[#FEDA75] via-[#FA7E1E] to-[#D62976] hover:opacity-90 text-white flex items-center justify-center transition-all hover:scale-110 shadow-lg">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative" x-data="{ copied: false }">
                        <button @click="navigator.clipboard.writeText('{{ route('polls.show', $poll->slug) }}'); copied = true; setTimeout(() => copied = false, 2000)"
...
@push('scripts')
    <script>
        ...
        function pollChart() {
            return {
                init() {
                    console.log('Poll chart initialized');
                }
            }
        }
    </script>
