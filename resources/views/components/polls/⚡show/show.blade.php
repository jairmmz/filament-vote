    ...
    <div class="container mx-auto max-w-7xl">
        ...
        <div class="dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden mb-8 border border-gray-200 dark:border-gray-700">
            <div class="w-full shadow-lg overflow-hidden bg-white dark:bg-slate-900">
                ...
                @else
                    <div class="relative w-full h-48 sm:h-64 md:h-96 lg:h-[300px] overflow-hidden rounded-xl bg-gradient-to-br from-red-600 via-rose-600 to-red-800">
                ...
                <div class="bg-white dark:bg-[#1D293D] rounded-lg shadow-lg p-6 overflow-hidden">
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-4 justify-center items-center flex-wrap">
                            ...
                            class="w-12 h-12 shrink-0 rounded-full bg-gradient-to-tr from-[#FEDA75] via-[#FA7E1E] to-[#D62976] hover:opacity-90 text-white flex items-center justify-center transition-all hover:scale-110 shadow-lg">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
