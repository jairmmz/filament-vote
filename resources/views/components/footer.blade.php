            ...
            <div class="lg:col-span-2">
                ...
                <div class="space-y-3 text-sm text-muted-foreground">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span>contacto@encuestasperu.pe</span>
                    </div>
        ...
        <div class="mb-5 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center justify-center gap-4">
                @php $socialLinks = [
                    ...
                    ['name' => 'Instagram', 'icon' => 'M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01M6.5 6.5h11v11h-11z M7.5 2h9a5.5 5.5 0 015.5 5.5v9a5.5 5.5 0 01-5.5 5.5h-9A5.5 5.5 0 012 16.5v-9A5.5 5.5 0 017.5 2z', 'href' => '#'],
                    ['name' => 'Youtube', 'icon' => 'M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 11.75a29 29 0 00.46 5.33A2.78 2.78 0 003.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 001.94-2 29 29 0 00.46-5.25 29 29 0 00-.46-5.33z M9.75 15.02l0-6.02 5.75 3.01-5.75 3.01z', 'href' => '#'],
                ];
                @endphp
