<section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
    ...
    {{-- Background Gradient --}}
    <div class="absolute inset-0 bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700"></div>
    ...
    {{-- Subtle pattern --}}
    <div class="absolute inset-0 opacity-[0.04] [mask-image:radial-gradient(ellipse_at_center,black,transparent_70%)]"
